...
outputDir = "/home/pdp1145/chest_xray_imgs/montreal_dataset/covid-chestxray-dataset-master/non_covid19_imgs_stanford"     # '../output' # Output directory to store selected images
